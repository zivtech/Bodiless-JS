...
jest.mock('../src/components/asBVComponent', () => (componentName: string, onLoaded: (bvprops: BVProps) => void) => (Component: CT) => (props: any) => {
...
const creatBVRatingsSummary = () => {
  ...
  jest.isolateModules(() => {
    ...
    BVRatingsSummary = require('../src/components/BVRatingsSummary').BVRatingsSummaryBase;
  });
